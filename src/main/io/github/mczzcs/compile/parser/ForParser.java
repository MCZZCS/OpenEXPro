...
public class ForParser implements BaseParser{
    ...
    public ForParser(ASTNode value_parser,ArrayList<ASTNode> bool,ArrayList<ASTNode> expression, ArrayList<BaseParser> parsers,FunctionParser fparser){
        this.bool = bool;
    ...
    public ASTNode eval(Parser parser, Compiler compiler, FunctionParser functionParser) throws CompileException {
        ...
        return new LoopNodeX(value_parser,bool,b,expression);
    }
}
